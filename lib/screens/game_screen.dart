...
class _GameScreenState extends State<GameScreen> {
  ...
  Widget createButton(index) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 3, vertical: 2.0),
      child: Center(
        child: WordButton(
    ...
    setState(() {
      ...
      if (hiddenWord == word) {
        ...
        Alert(
          ...
          title: word,
          desc: "WOW!!! You've guessed it right!",
          buttons: [
            DialogButton(
              radius: BorderRadius.circular(10),
              child: Text(
                        ...
                        child: Container(
                         margin: EdgeInsets.symmetric(horizontal: 20.0, vertical: 20),
                          ...
                          child: Center(
                              ...
                              child: Text(
                            "This is the word you can guess I hope $wordList This siasd adfasd sdafasdf adsfsdfsd dfgdfg  fasfsdf asdfdsfds agfdasfds dsfasdfsdf asdfsdf ",
                            style: qWordTextStyle,
                          )),
                        )),
                    Expanded(
                      flex: 1,
